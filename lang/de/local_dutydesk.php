...
$string['privacy:metadata:dutydesk_comment'] = 'Speichert von Nutzern erstellte Kommentare.';
$string['privacy:metadata:dutydesk_comment:content'] = 'Der vom Nutzer eingegebene Kommentartext.';
$string['privacy:metadata:dutydesk_comment:created'] = 'Der Zeitpunkt, zu dem der Kommentar erstellt wurde.';
$string['privacy:metadata:dutydesk_comment:userid'] = 'Der Nutzer, der den Kommentar erstellt hat.';
$string['privacy:metadata:dutydesk_department_manager'] = 'Speichert Zuordnungen von Dezernatsleitungen.';
$string['privacy:metadata:dutydesk_department_manager:assignedby'] = 'Der Nutzer, der die Dezernatsleitung zugeordnet hat.';
$string['privacy:metadata:dutydesk_department_manager:timecreated'] = 'Der Zeitpunkt, zu dem die Zuordnung erstellt wurde.';
$string['privacy:metadata:dutydesk_department_manager:userid'] = 'Die zugeordnete Dezernatsleitung.';
$string['privacy:metadata:dutydesk_import'] = 'Speichert Metadaten zu Aufgabenimporten.';
$string['privacy:metadata:dutydesk_import:created'] = 'Der Zeitpunkt, zu dem der Import erstellt wurde.';
$string['privacy:metadata:dutydesk_import:filename'] = 'Der importierte Dateiname.';
$string['privacy:metadata:dutydesk_import:importedby'] = 'Der Nutzer, der den Import durchgeführt hat.';
$string['privacy:metadata:dutydesk_position'] = 'Speichert Stellen und deren zugeordnete Hauptnutzer.';
$string['privacy:metadata:dutydesk_position:archivedtime'] = 'Der Zeitpunkt, zu dem die Stelle archiviert wurde.';
$string['privacy:metadata:dutydesk_position:primaryuserid'] = 'Der Hauptnutzer, der der Stelle zugeordnet ist.';
$string['privacy:metadata:dutydesk_position_deputy'] = 'Speichert Vertretungszuordnungen für Stellen.';
$string['privacy:metadata:dutydesk_position_deputy:assignedby'] = 'Der Nutzer, der die Vertretung zugeordnet hat.';
$string['privacy:metadata:dutydesk_position_deputy:timecreated'] = 'Der Zeitpunkt, zu dem die Vertretung erstellt wurde.';
$string['privacy:metadata:dutydesk_position_deputy:userid'] = 'Der als Vertretung zugeordnete Nutzer.';
$string['privacy:metadata:dutydesk_task_history'] = 'Speichert Aktivitätenhistorien zu Aufgaben.';
$string['privacy:metadata:dutydesk_task_history:action'] = 'Die Aktion des Historieneintrags.';
$string['privacy:metadata:dutydesk_task_history:details'] = 'Details zur Aktion des Historieneintrags.';
$string['privacy:metadata:dutydesk_task_history:timecreated'] = 'Der Zeitpunkt, zu dem der Historieneintrag erstellt wurde.';
$string['privacy:metadata:dutydesk_task_history:userid'] = 'Der Nutzer, der dem Historieneintrag zugeordnet ist.';
$string['privacy:metadata:dutydesk_taskassignment'] = 'Speichert Metadaten zu Aufgabenzuordnungen.';
$string['privacy:metadata:dutydesk_taskassignment:assignedby'] = 'Der Nutzer, der die Aufgabe zugeordnet hat.';
$string['privacy:metadata:dutydesk_taskassignment:timestamp'] = 'Der Zeitpunkt, zu dem die Aufgabenzuordnung aktualisiert wurde.';
$string['privacy:metadata:dutydesk_userinfo'] = 'Speichert zusätzliche DutyDesk-Nutzerzuordnungen.';
$string['privacy:metadata:dutydesk_userinfo:dutydeskrole'] = 'Die dem Nutzer zugewiesene DutyDesk-Rolle.';
$string['privacy:metadata:dutydesk_userinfo:userid'] = 'Der Moodle-Nutzer, der mit den DutyDesk-Informationen verknüpft ist.';
