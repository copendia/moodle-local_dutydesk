...
$string['privacy:metadata:dutydesk_comment'] = 'Stores comments created by users.';
$string['privacy:metadata:dutydesk_comment:content'] = 'The comment text entered by the user.';
$string['privacy:metadata:dutydesk_comment:created'] = 'The time when the comment was created.';
$string['privacy:metadata:dutydesk_comment:userid'] = 'The user who created the comment.';
$string['privacy:metadata:dutydesk_department_manager'] = 'Stores department lead assignments.';
$string['privacy:metadata:dutydesk_department_manager:assignedby'] = 'The user who assigned the department lead.';
$string['privacy:metadata:dutydesk_department_manager:timecreated'] = 'The time when the assignment was created.';
$string['privacy:metadata:dutydesk_department_manager:userid'] = 'The assigned department lead.';
$string['privacy:metadata:dutydesk_import'] = 'Stores task import metadata.';
$string['privacy:metadata:dutydesk_import:created'] = 'The time when the import was created.';
$string['privacy:metadata:dutydesk_import:filename'] = 'The imported file name.';
$string['privacy:metadata:dutydesk_import:importedby'] = 'The user who performed the import.';
$string['privacy:metadata:dutydesk_position'] = 'Stores positions and their assigned primary users.';
$string['privacy:metadata:dutydesk_position:archivedtime'] = 'The time when the position was archived.';
$string['privacy:metadata:dutydesk_position:primaryuserid'] = 'The primary user assigned to the position.';
$string['privacy:metadata:dutydesk_position_deputy'] = 'Stores deputy assignments for positions.';
$string['privacy:metadata:dutydesk_position_deputy:assignedby'] = 'The user who assigned the deputy.';
$string['privacy:metadata:dutydesk_position_deputy:timecreated'] = 'The time when the deputy assignment was created.';
$string['privacy:metadata:dutydesk_position_deputy:userid'] = 'The assigned deputy user.';
$string['privacy:metadata:dutydesk_task_history'] = 'Stores task activity history.';
$string['privacy:metadata:dutydesk_task_history:action'] = 'The task history action.';
$string['privacy:metadata:dutydesk_task_history:details'] = 'Details about the task history action.';
$string['privacy:metadata:dutydesk_task_history:timecreated'] = 'The time when the history entry was created.';
$string['privacy:metadata:dutydesk_task_history:userid'] = 'The user related to the task history entry.';
$string['privacy:metadata:dutydesk_taskassignment'] = 'Stores task assignment metadata.';
$string['privacy:metadata:dutydesk_taskassignment:assignedby'] = 'The user who assigned the task.';
$string['privacy:metadata:dutydesk_taskassignment:timestamp'] = 'The time when the task assignment was updated.';
$string['privacy:metadata:dutydesk_userinfo'] = 'Stores additional DutyDesk user assignment information.';
$string['privacy:metadata:dutydesk_userinfo:dutydeskrole'] = 'The DutyDesk role assigned to the user.';
$string['privacy:metadata:dutydesk_userinfo:userid'] = 'The Moodle user associated with the DutyDesk information.';
